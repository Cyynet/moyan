...
- (void)setImageLinkURL:(NSArray *)imageLinkURL
{
    ...
    if (self.placeHoldImage) {
        ...
        [_leftImageView sd_setImageWithURL:imageLinkURL[leftImageIndex]];
        [_centerImageView sd_setImageWithURL:imageLinkURL[centerImageIndex]];
        [_rightImageView sd_setImageWithURL:imageLinkURL[rightImageIndex]];
    }
