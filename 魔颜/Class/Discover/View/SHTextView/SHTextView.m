...
- (void)extendFrame
{
    if (_extendDirection == ExtendUp) {     // 向上伸长
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"NotiOfTextViewContentSizeHeightChangedHeigher" object:nil userInfo:@{@"MYHeigher" : @(offset)}];
...
//        [[NSNotificationCenter defaultCenter] postNotification:noti];
        [[NSNotificationCenter defaultCenter] postNotificationName:@"NotiOfTextViewContentSizeHeightChangedLower" object:nil userInfo:nil];
