...
- (void)LQPhotoPicker_initPickerView:(NSArray*)imagearr imagedata:(NSArray*)imagedata
{
    _showActionSheetViewController = self;
    ...
    _LQPhotoPicker_bigImageArray = (NSMutableArray *)imagearr;
    _LQPhotoPicker_smallImageArray= (NSMutableArray *)imagearr;
//    _LQPhotoPicker_selectedAssetArray=(NSMutableArray *)imagearr;
    _cacheImageArr = imagearr;
//    _LQPhotoPicker_bigImgDataArray = (NSMutableArray *)imagedata;
    
    self.pickerCollectionView.delegate=self;
    self.pickerCollectionView.dataSource=self;
    self.pickerCollectionView.backgroundColor = UIColorFromRGB(0xf7f7f7);
...
- (void) tapProfileImage:(UITapGestureRecognizer *)gestureRecognizer{
    ...
    if (index == (_LQPhotoPicker_smallImageArray.count)) {
        ...
        {
            if (!_LQPhotoPicker_selectedAssetArray.count) {
                if (_cacheImageArr.count) {
                    [cell setBigImgViewWithImage:_cacheImageArr[index]];
...
- (void)getSelectImgWithALAssetArray:(NSArray*)ALAssetArray thumbnailImgImageArray:(NSArray*)thumbnailImgArray{
    ...
    if (ALAssetArray.count) {
        ...
        _LQPhotoPicker_selectedAssetArray = [NSMutableArray arrayWithArray:_cacheImageArr];
    }
    //正方形缩略图 Array
